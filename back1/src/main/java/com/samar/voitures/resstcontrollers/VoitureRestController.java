...
public class VoitureRestController {
	...
	@GetMapping("/voitsByModel/{modele}")
		public List<Voiture> findByModeleVoitureContains(@PathVariable("modele") String modele) {
		return voitureService.findByModeleVoitureContains(modele);
	}
}
